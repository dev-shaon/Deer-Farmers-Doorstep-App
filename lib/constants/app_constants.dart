...
const String kkeyForgetOtpToken = 'kkeyForgetOtpToken';
const String kkeyisSubscribe = "isSubscribe";
const String kKeyLocationDialogShown = 'kKeyLocationDialogShown';

const String googleApiKeyy = "AIzaSyA-9OmmV8vaRrLOOW57zlW9ws4QPUb8S0c";
