...
import 'package:size_matter_swt/features/favorites/presentation/widgets/favorites_lists.dart';
...
class _FavoritesScreenState extends State<FavoritesScreen> {
  ...
  String get _screenTitle {
    switch (_selectedFilterIndex) {
      ...
      case 1:
        return 'Ranch Favorites';
      case 2:
        return 'Farm Favorites';
      default:
        return 'Event Favorites';
    }
  }
  ...
  Future<void> _loadFavorites() async {
    try {
      await getFavouriteRxObj.fetchFavoritesData();
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: StreamBuilder<FavouriteModel>(
        stream: getFavouriteRxObj.fillData.cast<FavouriteModel>(),
        builder: (context, snapshot) {
          ...
          final all = data?.data?.favorites ?? [];
          final favorites = all
              .where((f) => f.item?.type == _typeFilter)
              .toList();
              ...
              children: [
                ...
                Expanded(
                  child: favorites.isEmpty
                      ? Center(
                          child: Text(
                            "No ${_screenTitle.toLowerCase()} found",
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Padding(
                              ...
                              child: FavoritesLists(
                                favorite: favorite,
                                onTitleTap: () => _onFavoriteTap(favorite),
                              ),
                            );
                          },
                        ),
